...
const MusicVisualizer = () => {
  return (
    <section className="py-12 px-4 flex justify-center">
      <div className="w-full max-w-sm sm:max-w-md md:max-w-lg bg-[#2a1b3e] p-6 rounded-2xl border border-[#4c2a67] shadow-lg text-white">
            ...
            <div className="flex-1 mx-2 sm:mx-4">
              <div className="flex space-x-0.5 sm:space-x-1">
                {[...Array(40)].map((_, i) => (
                  <div
                    key={i}
                    className="w-0.5 sm:w-1 bg-blue-400/80"
                    style={{
